                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add Slider
                                    </li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" novalidate method="post" action="{{URL::to('slider_add')}}" enctype="multipart/form-data">@csrf
                                        <div class="form-row">
