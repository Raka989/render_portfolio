                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="table-re sponsive">
                                            <form method="post" action="{{URL::to('slider_update')}}" enctype="multipart/form-data">@csrf
                                                <div class="row filter-row">
                                                    <div class="form-group custom-mt-form-group">
                                                        <label>Name</label>
                                                            <input type="hidden" name="slider_id" class="form-control" value="{{$slider->slider_id}}"  placeholder="id">

                                                        <label>Image</label>
                                                        <input type="hidden" name="images" class="form-control" value="{{$slider->image}}"  placeholder="image">
                                                    </div>
