                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" novalidate method="post" action="{{URL::to('contact_add')}}" enctype="multipart/form-data">@csrf
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12 col-12 mb-3">
                                                <label for="validationTooltip02">contact name</label>
                                                <input type="text" class="form-control" name="name" id="validationTooltip02" placeholder="full-name" required />
                                            ...
                                            <div class="col-md-12 col-12 mb-3">
                                                ...
                                                <input type="email" class="form-control" name="email" id="validationTooltip03" placeholder="email" required />
                                                <div class="valid-tooltip">success</div>
